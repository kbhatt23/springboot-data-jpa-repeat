...
import com.learning.jpa.repository.StudentNativeQueryRepository;

@RestController
@RequestMapping("/nq/students")
public class StudentNativeQueryController {
	
	@Autowired
	private StudentNativeQueryRepository repository;
